...
public class JsonUtils {
    ...
    public static <Bean> ArrayList<Bean> parseArray(String jsonArrayString, ArrayParser<Bean> arrayParser) throws
            JSONException {
    ...
    public static <Bean> ArrayList<Bean> parseArray(JSONArray jsonArray, ArrayItemParser<Bean> arrayParser) throws
            JSONException {
    ...
    public static <Bean> ArrayList<Bean> parseArray(String jsonArrayString, ArrayItemParser<Bean> arrayParser) throws
            JSONException {
        if (isEmptyJson(jsonArrayString)) {
            return null;
        }
    ...
    public static <Bean> Bean parse(String jsonString, Class<Bean> beanClass, Parser<Bean> parser) throws
            JSONException {
    ...
    public static <Bean> Bean parse(JSONObject jsonObject, Class<Bean> beanClass, Parser<Bean> parser) throws
            JSONException {
        if (jsonObject == null) {
            return null;
        }
